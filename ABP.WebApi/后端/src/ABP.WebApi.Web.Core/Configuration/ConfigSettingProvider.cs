            ...
            return new[]
                {
                   ...
                   //其他设置
                   new SettingDefinition("config.MonggoDb.Server",_appConfiguration["App:MonggoDb:Server"],scopes: SettingScopes.Application | SettingScopes.Tenant),
                   new SettingDefinition("config.MonggoDb.DataBase",_appConfiguration["App:MonggoDb:DataBase"],scopes: SettingScopes.Application | SettingScopes.Tenant),
                   //任务执行间隔时间
                   new SettingDefinition("Hangfire.DefaultMin",_appConfiguration["Hangfire:DefaultMin"],scopes: SettingScopes.Application | SettingScopes.Tenant)
                };
        }
