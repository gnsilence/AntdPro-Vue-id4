...
namespace ASF.Domain.Entities
{
    ...
    public class Account : Entity
    {
        ...
        /// 手机号码
        /// </summary>
        public ABP.WebApi.Extensions.Values.PhoneNumber Telephone { get; set; }
        /// <summary>
        /// 邮箱地址
        /// </summary>
        ...
        /// </summary>
        [Required]
        public CreateOfAccount CreateInfo { get; private set; } = new CreateOfAccount("");
        /// <summary>
        /// 登录信息
        /// </summary>
        ...
        public void SetCreateOfAccount(string createOfAccountId)
        {
