...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class AutoMapperBuilderExtensions
    {
        ...
        public static IServiceCollection AddAutoMapperProfile(this IServiceCollection services)
        {
            ...
            //}
            //var cfg = new MapperConfiguration(f =>
            //{
            //    f.RegisterAllMappings(typeof(WebApiCoreModule).Assembly);
            //    f.RegisterAllMappings(typeof(WebApiEntityFrameworkModule).Assembly);
            //});
            
            //services.AddAutoMapper(typeof(WebApiCoreModule));
            services.AddAutoMapper(typeof(WebApiEntityFrameworkModule),typeof(WebApiCoreModule));
            return services;
        }
        ...
        public static void RegisterAllMappings(this IMapperConfigurationExpression config, Assembly assembly)
        {
            ...
            {
                //注册映射
                config.AddProfile(type); // Initialise each Profile classe
            }
        }
