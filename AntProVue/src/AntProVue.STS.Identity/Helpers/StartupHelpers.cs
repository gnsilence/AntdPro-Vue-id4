...
using AntProVue.STS.Identity.Configuration.ApplicationParts;
using AntProVue.STS.Identity.Configuration.Constants;
using AntProVue.STS.Identity.Configuration.Interfaces;
using AntProVue.STS.Identity.Helpers.Localization;
using AntProVue.STS.Identity.Services;
using System.Linq;
...
namespace AntProVue.STS.Identity.Helpers
{
